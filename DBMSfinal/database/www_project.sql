...
CREATE TABLE IF NOT EXISTS `books` (
  ...
  `book_language` varchar(40) COLLATE latin1_general_ci DEFAULT NULL,
  `book_dimension` varchar(40) COLLATE latin1_general_ci DEFAULT NULL,
  `book_pages` varchar(40) COLLATE latin1_general_ci DEFAULT NULL,
  `book_ranking` varchar(40) COLLATE latin1_general_ci DEFAULT NULL,
  `similar_isbn` varchar(40) COLLATE latin1_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `PhNo` varchar(60) COLLATE latin1_general_ci NOT NULL,
...
INSERT INTO `customers` (`customerid`, `name`, `address`, `city`, `zip_code`, `country`,`PhNo`,`password`) VALUES
(1, 'a', 'a', 'a', 'a', 'a','43545435','sfsd'),
(2, 'b', 'b', 'b', 'b', 'b','32523432','afsd'),
(3, 'test', '123 test', '12121', 'test', 'test','4353463','adsa');
...
CREATE TABLE IF NOT EXISTS `author` (
  ...
  `description` varchar(60) COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
INSERT INTO `author` (`authorid`, `author_name`,`description`) VALUES
(1, 'Jakob Iversen, Michael Eierman','sdf'),
(2, 'Peter Baines','sdf'),
(3, 'Dag H. Hanssen','sfsd'),
(4, 'Nicholas C. Zakas','sdfs'),
(5, 'Semmy Purewal','sdfsd'),
(6, 'Anton Kovalyov','sdfsd'),
(7,'Scott Hanselman','sdfds'),
(8,'Wallace Jackson','sdfsd'),
(9,'Mikael Olsson','fds'),
(10,'Joseph Albahari, Ben Albahari','sdf');

CREATE TABLE IF NOT EXISTS `supplier` (
  `supplierid` int(10) unsigned NOT NULL,
  `supplier_name` varchar(60) COLLATE latin1_general_ci NOT NULL,
  `supplier_rating` varchar(60) COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
INSERT INTO `supplier` (`supplierid`, `supplier_name`,`supplier_rating`) VALUES
(1, 'Ingram','4'),
(2, 'Baker & Taylor','4'),
(3, 'BCH Fullfillment and Distribution','3'),
(4, 'Atlantic Books','5'),
(5, 'Jaico Books','2'),
(6, 'India Book Distributers','3');
--
...
CREATE TABLE IF NOT EXISTS `supplies` (
  `book_isbn` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `supplierid` int(10) unsigned NOT NULL,
  `stock` varchar(60) COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

CREATE TABLE IF NOT EXISTS `contains` (
  `book_isbn` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `cartno` int(10) unsigned NOT NULL,
  `quantity` varchar(60) COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
ALTER TABLE `supplies`
  ADD PRIMARY KEY (`book_isbn`,`supplierid`);
  
ALTER TABLE `contains`
  ADD PRIMARY KEY (`book_isbn`,`cartno`);
--
